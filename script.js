document.getElementById("filterForm").addEventListener("submit", function (e) {
  ...
  const API_KEY = "AIzaSyAF6GJZYsJQFA-1K8-yFTseYZQ6lFNcZ7Q"; // 🔁 Replace with your actual YouTube API key
  ...
  const url = `https://www.googleapis.com/youtube/v3/search?key=${API_KEY}&part=snippet&type=video&maxResults=${MAX_RESULTS}&q=${encodeURIComponent(query)}`;
    ...
    .then((data) => {
      ...
      filteredVideos.forEach((video) => {
        ...
        videoCard.innerHTML = `
          ...
          <img src="${video.snippet.thumbnails.medium.url}" alt="Thumbnail" width="100%">
